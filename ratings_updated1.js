...
const DEFAULT_DISPLAY = {
  ...
  colorChoice:{ red:0, orange:0, yg:0, mg:0 }
};
...
// Sources
    ...
    dWrap.innerHTML=`
      ...
      <div class="mdbl-subtle">Color bands</div>
      <div class="mdbl-row wide">
        <div style="margin-left:auto;display:flex;flex-direction:column;gap:8px;min-width:var(--mdbl-right-col-wide)">
          <label>Red ≤ <input id="th_red" type="number" min="0" max="100" value="${(DISPLAY.colorBands&&DISPLAY.colorBands.redMax)!=null?DISPLAY.colorBands.redMax:50}" style="width:72px;text-align:right;"> %</label>
          <label>Orange ≤ <input id="th_orange" type="number" min="0" max="100" value="${(DISPLAY.colorBands&&DISPLAY.colorBands.orangeMax)!=null?DISPLAY.colorBands.orangeMax:69}" style="width:72px;text-align:right;"> %</label>
          <label>Orangy‑green ≤ <input id="th_yg" type="number" min="0" max="100" value="${(DISPLAY.colorBands&&DISPLAY.colorBands.ygMax)!=null?DISPLAY.colorBands.ygMax:79}" style="width:72px;text-align:right;"> %</label>
        </div>
      </div>
        ...
        <div style="margin-left:auto;display:flex;flex-direction:column;gap:8px;min-width:var(--mdbl-right-col-wide)">
          <label>Red
            <select id="col_red" class="mdbl-select">
              <option value="0" ${(DISPLAY.colorChoice&&DISPLAY.colorChoice.red===0)?'selected':''}>Default (#e53935)</option>
              <option value="1" ${(DISPLAY.colorChoice&&DISPLAY.colorChoice.red===1)?'selected':''}>Alt 1 (#f44336)</option>
              <option value="2" ${(DISPLAY.colorChoice&&DISPLAY.colorChoice.red===2)?'selected':''}>Alt 2 (#d32f2f)</option>
              <option value="3" ${(DISPLAY.colorChoice&&DISPLAY.colorChoice.red===3)?'selected':''}>Alt 3 (#c62828)</option>
            </select>
          </label>
          <label>Orange
            <select id="col_orange" class="mdbl-select">
              <option value="0" ${(DISPLAY.colorChoice&&DISPLAY.colorChoice.orange===0)?'selected':''}>Default (#fb8c00)</option>
              <option value="1" ${(DISPLAY.colorChoice&&DISPLAY.colorChoice.orange===1)?'selected':''}>Alt 1 (#f39c12)</option>
              <option value="2" ${(DISPLAY.colorChoice&&DISPLAY.colorChoice.orange===2)?'selected':''}>Alt 2 (#ffa726)</option>
              <option value="3" ${(DISPLAY.colorChoice&&DISPLAY.colorChoice.orange===3)?'selected':''}>Alt 3 (#ef6c00)</option>
            </select>
          </label>
          <label>Orangy‑green
            <select id="col_yg" class="mdbl-select">
              <option value="0" ${(DISPLAY.colorChoice&&DISPLAY.colorChoice.yg===0)?'selected':''}>Default (#9ccc65)</option>
              <option value="1" ${(DISPLAY.colorChoice&&DISPLAY.colorChoice.yg===1)?'selected':''}>Alt 1 (#c0ca33)</option>
              <option value="2" ${(DISPLAY.colorChoice&&DISPLAY.colorChoice.yg===2)?'selected':''}>Alt 2 (#aeea00)</option>
              <option value="3" ${(DISPLAY.colorChoice&&DISPLAY.colorChoice.yg===3)?'selected':''}>Alt 3 (#cddc39)</option>
            </select>
          </label>
          <label>Medium‑green
            <select id="col_mg" class="mdbl-select">
              <option value="0" ${(DISPLAY.colorChoice&&DISPLAY.colorChoice.mg===0)?'selected':''}>Default (#43a047)</option>
              <option value="1" ${(DISPLAY.colorChoice&&DISPLAY.colorChoice.mg===1)?'selected':''}>Alt 1 (#66bb6a)</option>
              <option value="2" ${(DISPLAY.colorChoice&&DISPLAY.colorChoice.mg===2)?'selected':''}>Alt 2 (#388e3c)</option>
              <option value="3" ${(DISPLAY.colorChoice&&DISPLAY.colorChoice.mg===3)?'selected':''}>Alt 3 (#81c784)</option>
            </select>
          </label>
        </div>
      </div>
  ...
  panel.querySelector('#mdbl-btn-save').addEventListener('click', ()=>{
    ...
    // display togglesprefs.display.colorNumbers      = panel.querySelector('#d_colorNumbers').checked;

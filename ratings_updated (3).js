...
(function settingsMenu(){
  ...
  #mdbl-panel header{position:sticky;top:0;background:rgba(22,22,26,0.96);padding:12px 16px;border-bottom:1px solid rgba(255,255,255,0.08);
    display:flex;align-items:center;gap:8px;cursor:movez-index:2;background:rgba(22,22,26,0.98);backdrop-filter:blur(8px);z-index: 999; background: rgba(22,22,26,0.98); backdrop-filter: blur(8px); box-shadow: 0 1px 0 rgba(255,255,255,0.08);}

    ...
    try {
        ...
        return {
            ...
            display: {
                ...
                showEpisodeRatings: p.display?.showEpisodeRatings ?? DEFAULTS.display.showEpisodeRatings,
...
function renderMenuContent(panel) {
    ...
    <div class="mdbl-section" id="mdbl-sec-display">
        ...
        ${row('Show episode ratings', `<input type="checkbox" id="d_ep_rate" ${CFG.display.showEpisodeRatings?'checked':''}>`)}
    ...
    const updateLiveAll = () => {
        ...
        CFG.display.showEpisodeRatings = panel.querySelector('#d_ep_rate').checked;

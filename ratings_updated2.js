...
(function settingsMenu(){
  ...
  #mdbl-panel header{position:sticky;top:0;background:rgba(22,22,26,0.96);padding:12px 16px;border-bottom:1px solid rgba(255,255,255,0.08);
    display:flex;align-items:center;gap:8px;cursor:movez-index:2;background:rgba(22,22,26,0.98);backdrop-filter:blur(8px);}
  ...
  .mdbl-num{width:72px;text-align:right;margin-left:6px;}
...
// Sources
    ...
    dWrap.innerHTML=`
      ...
      <div class="mdbl-grid">
        <div class="grid-row">
          <label>Red ≤ <input id="th_red" type="number" min="0" max="100" value="${(DISPLAY.colorBands&&DISPLAY.colorBands.redMax)!=null?DISPLAY.colorBands.redMax:50}" class="mdbl-num"> %</label>
        ...
        <div class="grid-row">
          <label>Orange ≤ <input id="th_orange" type="number" min="0" max="100" value="${(DISPLAY.colorBands&&DISPLAY.colorBands.orangeMax)!=null?DISPLAY.colorBands.orangeMax:69}" class="mdbl-num"> %</label>
          <div class="grid-right">
        ...
        <div class="grid-row">
          <label>Orangy‑green ≤ <input id="th_yg" type="number" min="0" max="100" value="${(DISPLAY.colorBands&&DISPLAY.colorBands.ygMax)!=null?DISPLAY.colorBands.ygMax:79}" class="mdbl-num"> %</label>
          <div class="grid-right">
